...
label.setGeometry(QtCore.QRect(60, 240, 131, 21))
font=QtGui.QFont()
...
label_3.setGeometry(QtCore.QRect(60, 330, 78, 13))
font = QtGui.QFont()
font.setFamily("Tw Cen MT")
font.setPointSize(12)
font.setBold(True)
...
label_4.setGeometry(QtCore.QRect(250, 330, 56, 13))
font = QtGui.QFont()
font.setFamily("Tw Cen MT")
font.setPointSize(12)
font.setBold(True)
...
label_5.setGeometry(QtCore.QRect(60, 427, 150, 17))
font = QtGui.QFont()
font.setFamily("Tw Cen MT")
font.setPointSize(12)
font.setBold(True)
...
def onClick():
    web=[webAdd.text(), startDate.date().toPyDate(), startTime.time().toPyTime().strftime("%H:%M:%S"), endDate.date().toPyDate(), endTime.time().toPyTime()]
    webs.append(web)
    print(webs)
    addTableRow(tableBlocked, web)
...
# row=tableBlocked.rowCount()


# Choti moti bachi hui coding:
...
for j in webs:
    d(webs[1],webs[2]])<d.now()<d(webs[3],webs[4]):
        with open(host,"r+") as file:
            content=file.read()
            for website in data.website_name:
